  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col x1:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
        ...
        <span className='text-white font-poppins'>20% </span>
        DISCOUNT FOR {" "}
        <span className='text-white font-poppins'>1 MONTH</span> ACCOUNT
        </p>
      </div>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-4`}>
        Our team of experts uses a methodology to identify the credit cards most likely to fit you needs.
